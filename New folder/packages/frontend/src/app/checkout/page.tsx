...
const navigation = [
  { name: 'Home', href: '#', icon: UserCircleIcon, current: true },
  { name: 'History', href: '#', icon: UserGroupIcon, current: false },
  { name: 'Billing', href: '#', icon: CreditCardIcon, current: false },
  { name: 'Invoices', href: '#', icon: KeyIcon, current: false },
  { name: 'API', href: '#', icon: ViewfinderCircleIcon, current: false },
]
