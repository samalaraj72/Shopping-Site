export default function ProfilePage() {
  return (
    <form className="divide-y-gray-200 lg:col-span-9" action="#" method="POST">
        ...
        <div className="mt-6 grid grid-cols-12 gap-6">
          <div className="col-span-12 sm:col-span-6">
            ...
            <input
              ...
              className="mt-1 block w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm"
            />
          </div>
