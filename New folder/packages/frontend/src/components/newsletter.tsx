export const Newsletter = () => {
  return (
    <div className="bg-gray-800">
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center">
        ...
        <div className="mt-8 lg:mt-0 lg:ml-8">
          <form className="sm:flex">
            ...
            <input
              ...
              autoComplete="email"
              required
              className="w-full px-5 py-3 border border-transparent rounded-md placeholder-gray-500 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white focus:border-white sm:max-w-xs"
